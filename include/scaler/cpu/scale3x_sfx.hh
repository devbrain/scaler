...
namespace scaler {
    ...
    void scale_scale_3x_sfx(const InputImage& src, OutputImage& result, size_t scale_factor = 3) {
        ...
        for (size_t y = 0; y < src.height(); y++) {
            ...
            for (size_t x = 0; x < src.width(); x++) {
                ...
                auto E1 = ((B == D && B != F && D != H && (E != A || E == C || E == G || A == J || A == K) && E != C) ||
                           (B == F && B != D && F != H && (E != C || E == A || E == I || C == J || C == L) && E != A))
                              ? B
                              : E;

                auto E3 = ((B == D && B != F && D != H && (E != A || E == C || E == G || A == J || A == K) && E != G) ||
                           (D == H && B != D && F != H && (E != G || E == A || E == I || G == K || G == M) && E != A))
                              ? D
                              : E;

                auto E5 = ((F == H && B != F && D != H && (E != I || E == C || E == G || I == L || I == M) && E != C) ||
                           (B == F && B != D && F != H && (E != C || E == A || E == I || C == J || C == L) && E != I))
                              ? F
                              : E;

                auto E7 = ((F == H && B != F && D != H && (E != I || E == C || E == G || I == L || I == M) && E != G) ||
                           (D == H && B != D && F != H && (E != G || E == A || E == I || G == K || G == M) && E != I))
                              ? H
                              : E;
    ...
    template<typename InputImage, typename OutputImage>
    OutputImage scale_scale_3x_sfx(const InputImage& src, size_t scale_factor = 3) {
        OutputImage result(src.width() * scale_factor, src.height() * scale_factor, src);
        scale_scale_3x_sfx(src, result, scale_factor);
        return result;
    }
}
