...
#define WDIFF(c1, c2) yuvDifference(c1, c2)
    ...
    inline static T interpolate3Pixels(T c1, int32_t w1, T c2, int32_t w2, T c3, int32_t w3, int32_t s) noexcept {
        ...
        return T{
            static_cast<unsigned int>((static_cast<int32_t>(c1.x) * w1 + static_cast<int32_t>(c2.x) * w2 + static_cast<int32_t>(c3.x) * w3) >> s),
            static_cast<unsigned int>((static_cast<int32_t>(c1.y) * w1 + static_cast<int32_t>(c2.y) * w2 + static_cast<int32_t>(c3.y) * w3) >> s),
            static_cast<unsigned int>((static_cast<int32_t>(c1.z) * w1 + static_cast<int32_t>(c2.z) * w2 + static_cast<int32_t>(c3.z) * w3) >> s)
        };
    }
